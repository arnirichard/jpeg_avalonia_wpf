...
namespace DAW.HarmonicGenerator
{
    class HarmoicGeneratorViewModel : ViewModelBase
    {
        ...
        public void SetHarmonic(Harmonic harmonic, PlotData? amplitudes = null)
        {
            Harmonic = harmonic;
            Period = CreatPlotData(amplitudes);
            OnPropertyChanged("Period");
        }

        PlotData CreatPlotData(PlotData? amplitudes = null)
        {
            float[] period = Harmonic.CreatePeriod(SampleRate, true);
